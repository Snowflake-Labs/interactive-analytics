...
export CONNECTION DB SCHEMA IMAGE_REPO ROLE DEPLOY_WAREHOUSE \
       ...
       API_DATABASE API_ROLE API_WAREHOUSE API_PORT \
       INTERACTIVE_WAREHOUSE STANDARD_WAREHOUSE \
       INTERACTIVE_SCHEMA STANDARD_SCHEMA \
       LOCUST_HOST LOCUST_WEB_PORT LOCUST_USERS LOCUST_SPAWN \
       LOCUST_HEADLESS LOCUST_RUN_TIME LOCUST_WAREHOUSE
